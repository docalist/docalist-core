...
interface MappingBuilder
{
     ...
     * @return self
     *
     * @throws InvalidArgumentException Si l'analyseur indiqué n'existe pas.
     */
    ...
    /**
     * Indique que le champ est de type 'keyword' (une chaine mais pas du texte dans une langue donnée).
     *
     * Lors de l'indexation, aucun traitement particulier ne sera fait sur les données, elles seront
     * stockées "telles quelles" dans le moteur de recherche.
     *
     * @return self
     */
    ...
    /**
     * Réinitialise le builkder pour générer un nouveau mapping.
     *
     * @return self
     */
